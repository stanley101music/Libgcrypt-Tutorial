...
// [TODO]
// Specify the preferred symmetric cryptography algorithm and the mode of operation
...
int main()
{
    ...
    // [TODO] Choose the value of ```flags``` according to the cryptography algorithm and the mode of operation
    err = gcry_cipher_open(&cipher_hd, CRYPTO_ALG, MODE_OF_OP, );
